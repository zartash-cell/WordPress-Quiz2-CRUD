      ...
      <main className="flex flex-col bg-white">
        ...
        <section className="flex min-h-screen bg-white" id="home">
          <div className="w-1/2 flex flex-col justify-center items-start px-16">
            ...
            <button className="bg-blue-500 text-black font-bold px-8 py-3 rounded uppercase text-xl hover:text-red-600 hover:bg-blue-600 transition">
              Get Started
            </button>
          </div>

          {/* Right Half: Image */}
          <div className="w-1/2 relative"> {/* Ensure the parent container has 'relative' positioning */}
            <Image
              src="/images/img.avif" // Replace with your image path
              alt="CMS Dashboard"
              fill // Use fill to make the image stretch and fill the parent
